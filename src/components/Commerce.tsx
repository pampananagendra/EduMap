...
const Commerce: React.FC<CommerceProps> = ({
  language = 'en',
  states = [],
  ...
  // Fetch commerce colleges from backend
  useEffect(() => {
    const fetchColleges = async () => {
      try {
        ...
        const response = await fetch('http://localhost:5001/api/colleges/commerce');
        ...
        console.error('Error fetching commerce colleges:', err);
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Commerce colleges...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Explore top commerce colleges offering B.Com, BBA, and other business-related programs. 
            Find the ideal institution to launch your career in business and finance.
          </p>
