...
const Arts: React.FC = () => {
  ...
  // Fetch arts colleges from backend
  useEffect(() => {
    const fetchColleges = async () => {
      try {
        setLoading(true);
        const response = await fetch('http://localhost:5001/api/colleges/arts');
        ...
        console.error('Error fetching arts colleges:', err);
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Arts & Humanities colleges...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover top colleges for Arts, Literature, Social Sciences, and Humanities. 
            Find the perfect institution to pursue your passion for liberal arts education.
          </p>
